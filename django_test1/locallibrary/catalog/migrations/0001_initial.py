# Generated by Django 5.0.1 on 2024-01-08 21:44
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Enter a book genre (e.g. Science Fiction, Poetry, etc.)', max_length=200, unique=True)),
            ],
        ),
        migrations.CreateModel(
            name='Book',
